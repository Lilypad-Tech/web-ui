...
export function toTableData({
  ...
  return sort(nodeStatusData, (a, b) =>
    ...
    return {
      ...
      "Available ETH": ethBalances.find((balance) => balance.address === Wallet)
        ?.balance,
      "Available LP": lpBalances.find((balance) => balance.address === Wallet)
        ?.balance,
  ...
  return [
		...
		}, */
    {
      ...
      tooltip: {
        ...
        description: m.node_status_header_tooltip_description_available_eth(),
      },
    },
    {
      name: "Available LP",
      ...
      tooltip: {
        ...
        description: m.node_status_header_tooltip_description_available_lp(),
      },
    },
    {
