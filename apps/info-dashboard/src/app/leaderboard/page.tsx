                            ...
                            <TableLeadText>
                              {{
                                title: (
                                  ...
                                  >
                                    {rowIndex < 5
                                      ? m.leaderboard_node_provider_table_first_level()
                                      : rowIndex < 15
                                      ? m.leaderboard_node_provider_table_second_level()
                                      : rowIndex < 35
                                      ? m.leaderboard_node_provider_table_third_level()
                                      : m.leaderboard_node_provider_table_last_level()}
                                  </Badge>
                                ),
                              }}
                            </TableLeadText>
