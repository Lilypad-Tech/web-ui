      ...
      <div className=" ">
        ...
        <SectionContainer className="sm:pt-uui-container-padding-desktop mx-auto pt-uui-container-padding-mobile">
          ...
          <div className="flex flex-col mb-uui-xl md:mb-uui-4xl space-y-uui-xl md:space-y-uui-none md:flex-row md:space-x-uui-3xl">
            ...
            <CardWithBorder title={m.leaderboard_incentive_program_title()}>
              <div className="flex space-x-uui-5xl">
                <div className="flex-col flex space-y-uui-xs">
                  <span className="uui-text-sm font-medium text-uui-text-tertiary-600">
            ...
            {{
              ...
              tableSubstitute:
                ...
                leaderboardData?.filter((d) =>
                  ...
                  <EmptyState
                    header={
                      leaderboardIsLoading || nodesIsLoading
                  ...
                  >
                    <FeaturedIcon
                      spinIcon={leaderboardIsLoading || nodesIsLoading}
                      iconUrl={
                        leaderboardIsLoading || nodesIsLoading
                          ? generalLoading01
                          : leaderboardIsError || nodesIsError
                    ...
                    {toTableData({
                      ...
                      .map((row, rowIndex) => (
                        <tr key={rowIndex}>
                          ...
                          <td>
                            <TableLeadText title={row["Reward Points"]} />
                          </td>
                          {/* <td>
														<TableLeadText
															title={
                          ...
                          <td>
                            <TableLeadText
                              title={
                                <a
                                  href={row["Share"].getUrl({
                                    currentUrl,
                                    currentLevel: row.Level.text,
                                  })}
                                  target="_blank"
