    ...
    return (
        <>
            ...
            <div className=" ">
                ...
                />
                <SectionContainer className="sm:pt-uui-container-padding-desktop pt-uui-container-padding-mobile mx-auto">
                    <div className="mb-uui-xl md:mb-uui-4xl space-y-uui-xl md:space-y-uui-none md:space-x-uui-3xl flex flex-col md:flex-row">
                        <CardWithBorder
                            className="md:[&&]:w-1/2"
                            title={m.leaderboard_node_count_card_title()}
                        >
                            <div className="space-x-uui-5xl flex">
                                <div className="space-y-uui-xs flex flex-col">
                                    <span className="uui-text-sm text-uui-text-tertiary-600 font-medium">
                    ...
                    <Table className="relative max-h-[70vh] min-h-[70vh]">
                        {{
                            cardHeader: (
                                <CardHeader
                                    className="bg-uui-bg-primary sticky left-0 right-0 top-0 z-10 box-border"
                            ...
                            tableRows: (
                                <>
                                    <thead className="">
                                        ...
                                        <tr className="after:border-t-uui-1 after:border-t-uui-border-secondary sticky top-0 z-10 w-full after:absolute after:inset-x-0 after:bottom-0 after:w-full">
                                            {getHeaderData().map(
                                                (
                                                    {
                                                        name,
                                            ...
                                            .map((row, rowIndex) => (
                                                <tr key={rowIndex}>
                                                    <td>
                                                        <TableLeadText
                                                            title={
                                                                <div className="space-x-uui-md flex">
                                                                    <Badge
                                                                        onClick={() => {
                                                                            const url =
