                  ...
                  {{
                    badge: (
                      <Badge
                        ...
                        size="md"
                      >
                        {isLoading ? "0" : isError ? "err" : percentage}
                      </Badge>
                    ),
                    header: isLoading ? (
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          ...
                          >
                            <defs>
                              ...
                              >
                                ...
                                <stop
                                  offset="100%"
                                  style={{
                                    stopColor: "rgb(var(--color-uui-black))",
                                    stopOpacity: 0,
                                  }}
                                />
                              </linearGradient>
                            ...
                            <XAxis
                              ...
                              scale="time"
                              type="number"
                              tickFormatter={(epochMillis) =>
                                DateTime.fromMillis(epochMillis).toFormat(
                                  "MM yyyy"
                                )
                              }
                              domain={["auto", "auto"]}
