            ...
            <animated.div style={fade} className="sticky top-0 w-full z-40">
              ...
              >
                {nestedMenu != null && menuOpened ? (
                  ...
                  >
                    <_NavItemBase current={true}>{"Back"}</_NavItemBase>
                  </button>
                ) : null}
                {menuOpened ? (
                  <>
                    {nestedMenu === null && (
                      <>
                        ...
                        >
                          <_NavItemBase current={pathname === "/docs"}>
                            {"Docs"}
                          </_NavItemBase>
                        </Link>
                      </>
                  ...
                  <>
                    <_NavItemDropdown current={pathname === "/About"}>
                      {{
                        title: "About",
                        dropdownList: (
                          <>
                    ...
                    <_NavItemDropdown current={pathname === "/Resources"}>
                      {{
                        title: "Resources",
                        dropdownList: (
                          <>
