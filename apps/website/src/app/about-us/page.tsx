                ...
                <div className="flex space-x-uui-xl">
                  ...
                  <div className="flex flex-col items-start justify-center spacing-y-uui-md ">
                    ...
                    <p className="uui-text-sm md:uui-text-md font-regular text-uui-text-tertiary-600  antialiased">
                      ...
                      decentralized AI and computing, fostering an open,
                      equitable, and accessible technological ecosystem.
                    </p>
                  </div>
                </div>
                <div className="flex space-x-uui-xl">
                  <FeaturedIcon iconUrl={mapsAndTravelFlag02} />
                  <div className="flex flex-col items-start justify-center spacing-y-uui-md">
                    <span className="text-uui-text-primary-900 font-semibold antialiased uui-text-lg md:uui-text-xl">
                      Mission
                    </span>
                    <p className="uui-text-sm md:uui-text-md font-regular text-uui-text-tertiary-600  antialiased">
                      To democratize access to cutting-edge AI and computing
                      resources by leveraging web3 technologies, fostering an
                      inclusive, transparent, and decentralized ecosystem that
                      empowers individuals and communities to innovate,
                      collaborate, and drive positive change in the world.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <SectionContainer className="bg-uui-bg-primary">
            ...
            >
              <p className="w-1/2 text-center mx-auto py-4 uui-text-md antialiased text-uui-text-primary-900">
                Lilypad is built on the pillars of decentralization,
                accessibility, and collaboration, empowering a community-driven
