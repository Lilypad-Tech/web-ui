    ...
    <NavBarContext.Provider
      value={{
        menu: {
          ...
          setOpened: openedState ? openedState.setOpened : setMenuOpened,
        },
      }}
    >
      <div
      ...
      >
        ...
        <SectionContainer>
          ...
          <div className="flex gap-uui-xl items-center">
            {logo}
            <div className="gap-uui-xs hidden uui-desktop:flex">{children}</div>
            <div className="ml-auto flex gap-uui-xl">
              <div className="uui-desktop:hidden">{dropdown}</div>

              <div className="uui-desktop:flex hidden">{trailingCTA}</div>

              <div className=" uui-desktop:hidden">{menuButton}</div>
            </div>
          </div>
        </SectionContainer>
      </div>
      ...
      <div
        className={twMerge(
          ...
          (openedState ? openedState.opened : menuOpened) ? "" : "hidden"
        )}
      >
        {menuButton}
        <div className="flex flex-col items-center gap-uui-md">{children}</div>
