      ...
      <div className="max-w-[45rem] mx-auto">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-uui-text-tertiary-600">
            <li>
              Cookies: Our website uses basic cookies to improve functionality,
              track usage patterns, and enhance user experience. You can manage
              cookie settings in your browser at any time.
            </li>
            <li>
              Newsletter Subscriptions: When subscribing to our newsletter, we
              collect your email address to send you updates and information
              about our services.
            </li>
            <li>
              Website Analytics: We may use tools to collect anonymized data,
              such as browser type, time spent on the site, and pages visited.
            </li>
            <li>
              Our website may contain links to documentation, blogs, and other
              resources hosted on third-party platforms but managed by Lilypad
              Network Inc. While we make every effort to ensure the security and
              privacy of these resources, please be aware that accessing these
              resources may involve third-party services (e.g., hosting or
              content delivery networks) with their own privacy practices.
              Lilypad Network Inc. is not responsible for the privacy practices
              or policies of these third-party platforms. We encourage users to
              review the privacy policies of these platforms before interacting
              with the content.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-uui-text-tertiary-600">
            <li>
              Managing Cookies: You can configure your browser to refuse cookies
              or alert you when cookies are being sent.
            </li>
            <li>
              Unsubscribing from Emails: You can opt out of our newsletter at
              any time by using the &quot;Unsubscribe&quot; link or contacting
              us directly.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <div className="p-6border border-gray-200 rounded-md shadow-md max-w-md">
            <h2 className="text-xl font-semibold text-uui-text-primary-900">
              Lilypad Network Inc.
            </h2>
            ...
            <p className="text-uui-text-tertiary-600">
              Email:
              <a href="mailto:contact@lilypad.tech" className="hover:underline">
