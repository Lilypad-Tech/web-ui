...
const BadgeWrapper = ({
	...
	const backgroundLayer = {
		"Pill outline": {
			...
			brand: "text-uui-utility-brand-600 ring-uui-utility-brand-700 ring-[0.09375rem] rounded-full",
			error: "text-uui-utility-error-600 ring-uui-utility-error-700 ring-[0.09375rem] rounded-full",
			warning:
		...
		"Pill color": {
			...
			brand: "bg-uui-utility-brand-50 text-uui-utility-brand-700 ring-uui-utility-brand-200 ring-[0.063rem] rounded-full",
			error: "bg-uui-utility-error-50 text-uui-utility-error-700 ring-uui-utility-error-200 ring-[0.063rem] rounded-full",
			warning:
