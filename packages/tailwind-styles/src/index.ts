...
export const preset: ReturnType<typeof getPreset> = merge(
        ...
        colorModes: {
          root: {
            darkModes: {
              ...
              "text-brand-secondary-700": "var(--color-uui-brand-300)",
              ...
              "text-secondary_on-brand": "var(--color-uui-base-white)",
              ...
              "button-primary-border_hover": "var(--color-uui-brand-700)",
              "button-primary-fg": "var(--color-uui-brand-900)",
              "button-secondary-color-border": "var(--color-uui-brand-100)",
              "button-secondary-color-fg": "var(--color-uui-brand-100)",
  ...
  }),
  {
    theme: {
      extend: {
        fontFamily: {
          "uui-display-2xl": "Plus Jakarta Sans Variable",
          "uui-display-xl": "Plus Jakarta Sans Variable",
          "uui-display-lg": "Plus Jakarta Sans Variable",
          "uui-display-md": "Plus Jakarta Sans Variable",
          "uui-display-sm": "Plus Jakarta Sans Variable",
          "uui-display-xs": "Plus Jakarta Sans Variable",
          "uui-text-xl": "Inter Variable",
          "uui-text-lg": "Inter Variable",
          "uui-text-md": "Inter Variable",
          "uui-text-sm": "Inter Variable",
          "uui-text-xs": "Inter Variable",
        },
      },
    },
  }
